...
/// @notice DEPRECATED: This is the legacy V1 user registry contract. Use the new UserRegistry from v2 instead.
contract DeprecatedUserRegistry is AccessControl {
